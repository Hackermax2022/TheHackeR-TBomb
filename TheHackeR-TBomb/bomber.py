...
def do_zip_update():
    success = False
    if DEBUG_MODE:
        zip_url = "https://github.com/Hackermax2022/TheHackeR-TBomb.git"
        dir_name = "TBomb-HackeR"
    else:
        zip_url = "https://github.com/Hackermax2022/TheHackeR-TBomb.git"
    ...
    if success:
        ...
        mesgdcrt.WarningMessage(
            "Grab The Latest one From https://github.com/Hackermax2022/TheHackeR-TBomb.git")
...
def do_git_update():
    ...
    if success:
        ...
        print(
            "git checkout . && "
            "git pull https://github.com/Hackermax2022/TheHackeR-TBomb.git HEAD")
    sys.exit()
...
def notifyen():
    try:
        if DEBUG_MODE:
            url = "https://github.com/Hackermax2022/TheHackeR-TBomb.git"
        else:
            url = "https://github.com/Hackermax2022/TheHackeR-TBomb.git"
...
def selectnode(mode="sms"):
    ...
    try:
        ...
        max_limit = {"sms": 5000, "call": 500, "mail": 1000}
        cc, target = "", ""
        if mode in ["sms", "call"]:
